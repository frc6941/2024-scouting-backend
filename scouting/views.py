...
def record_dump(record: models.Record):
    return {
        ...
        'offense_skill': record.offense_skill,
        'defense_skill': record.defense_skill,
        'died': record.died,
...
def upload_record(request):
    ...
    record = Record.objects.create(
        ...
        auto_amp_scored=form.cleaned_data.get('autoAmpScores'),
        auto_amp_missed=form.cleaned_data.get('autoAmpMissed'),
        auto_speaker_scored=form.cleaned_data.get('autoSpeakerScore'),
